        ...
        <div className="flex-1 p-8 bg-gray-50/30 overflow-y-auto">
            <div className="mb-10">
                ...
                <p className="text-gray-500 font-medium mt-2 text-lg">
                    Vous avez atteint <span className="text-blue-600">{stats.completionRate}%</span> de vos objectifs. Continuez comme ça !
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <StatCard icon={CheckCircle} title="Terminées" value={stats.completed} color="emerald" />
                <StatCard icon={Clock} title="En cours" value={stats.pending} color="amber" />
                <StatCard icon={AlertTriangle} title="En retard" value={stats.overdue} color="rose" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        <div>
                            <div className="flex justify-between mb-3 items-end">
                                <span className="text-gray-500 font-bold text-sm uppercase tracking-widest">Progression globale</span>
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-4">
                            <MiniStat label="Success" value={stats.completed} sub="Tâches terminées" color="text-emerald-600" />
                            <MiniStat label="Active" value={stats.pending} sub="À faire" color="text-amber-600" />
                            <MiniStat label="Critique" value={stats.overdue} sub="Retardées" color="text-rose-600" />
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-bold text-gray-900">7 prochains jours</h3>
                    ...
                    <div className="space-y-4 flex-1">
                        {stats.upcoming.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center text-center opacity-40 py-10">
                                ...
                                <p className="font-medium">Tout est en ordre pour l'instant !</p>
                            </div>
                        ) : (
